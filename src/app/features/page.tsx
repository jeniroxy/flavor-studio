...
import { Studios } from "@/components/features/studios";
import {
  Block,
  BlueButton,
  HeroBackdrop,
...
export const metadata: Metadata = {
  title: "Features",
  description:
    "Six studios — recipes, nutrition, ideation, taste tests, projects and CRM — sharing one ingredient library and one live cost model.",
};
...
export default function FeaturesPage() {
  return (
    <PageShell active="features">
        ...
        <div className="relative">
          <div className="mx-auto grid max-w-[1180px] grid-cols-[repeat(auto-fit,minmax(min(100%,300px),1fr))] items-center gap-[clamp(28px,3.4vw,52px)]">
            <div>
              ...
              >
                Six studios. One source of truth.
              </Reveal>
              <Reveal
                as="p"
                delay={0.12}
              ...
              >
                ...
                labels, projects, sensory and CRM — sharing one ingredient
                library and one live cost model.
              </Reveal>
            </div>
      ...
      <CtaBand
        title="See all six studios on your own formulas."
